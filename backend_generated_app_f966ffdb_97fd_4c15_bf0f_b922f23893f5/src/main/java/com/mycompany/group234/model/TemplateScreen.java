...
public class TemplateScreen {
  ...
  private String screenFilePath;
	...
	@JoinColumn(name = "\"TemplateScreenScreenshotBig\"", referencedColumnName = "\"DocId\"", insertable = false, updatable = false)
	private Document screenshotBig;
	
	@Column(name = "\"TemplateScreenScreenshotBig\"")
	private Long templateScreenScreenshotBig;
	@OneToOne(cascade = CascadeType.ALL)
	@JoinColumn(name = "\"TemplateScreenScreenshotSmall\"", referencedColumnName = "\"DocId\"", insertable = false, updatable = false)
	private Document screenshotSmall;
	
	@Column(name = "\"TemplateScreenScreenshotSmall\"")
	private Long templateScreenScreenshotSmall;
   
	@OneToMany(fetch = FetchType.LAZY, cascade = {CascadeType.PERSIST, CascadeType.REMOVE, CascadeType.MERGE})
@JoinTable(
            name="\"TemplateScreenFeatures\"",
            joinColumns = @JoinColumn( name="\"TeScreenId\""),
